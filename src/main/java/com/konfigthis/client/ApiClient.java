...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://uploadthing.com/api";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("ApiKeyAuth", new ApiKeyAuth("header", "x-uploadthing-api-key"));
    ...
    private void init() {
        ...
        setUserAgent("Konfig/6.4.0/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://uploadthing.com/api)
